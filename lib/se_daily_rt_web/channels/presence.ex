defmodule SEDailyRTWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule SEDailyRT.MyChannel do
        use SEDailyRTWeb, :channel
        alias SEDailyRT.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :se_daily_rt,
                        pubsub_server: SEDailyRT.PubSub
end
